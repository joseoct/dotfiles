...
globalkeys = mytable.join(
  ...
  -- Visual Studio Code
  awful.key({ altkey }, "v", function() awful.util.spawn("code") end,
    { description = "run visual studio code", group = "applications" }),
  ...
  awful.key({ altkey, "Control", "Shift" }, "h",
    function()
      -- get current tag
...
clientkeys = mytable.join(
  ...
  awful.key({ altkey, }, "m", function(c) c:swap(awful.client.getmaster()) end,
...
awful.spawn.once("streamlink-twitch-gui")
